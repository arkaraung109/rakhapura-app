...
public class StudentClassMapperImpl implements StudentClassMapper {
    ...
    @Override
    public StudentClassDto mapEntityToDto(StudentClass entity) {
        if ( entity == null ) {
            return null;
        }
        ...
        studentClassDto.setId( entity.getId() );
        studentClassDto.setRegNo( entity.getRegNo() );
        studentClassDto.setRegSeqNo( entity.getRegSeqNo() );
        studentClassDto.setArrival( entity.isArrival() );
        studentClassDto.setCreatedTimestamp( entity.getCreatedTimestamp() );
        studentClassDto.setExamTitle( examTitleToExamTitleDto( entity.getExamTitle() ) );
        studentClassDto.setStudentClass( classToClassDto( entity.getStudentClass() ) );
        studentClassDto.setHostel( hostelToHostelDto( entity.getHostel() ) );
        studentClassDto.setStudent( studentToStudentDto( entity.getStudent() ) );

        return studentClassDto;
    }

    @Override
    public StudentClass mapDtoToEntity(StudentClassDto dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        studentClass.setId( dto.getId() );
        studentClass.setRegNo( dto.getRegNo() );
        studentClass.setRegSeqNo( dto.getRegSeqNo() );
        studentClass.setArrival( dto.isArrival() );
        studentClass.setCreatedTimestamp( dto.getCreatedTimestamp() );
        studentClass.setExamTitle( examTitleDtoToExamTitle( dto.getExamTitle() ) );
        studentClass.setStudentClass( classDtoToClass( dto.getStudentClass() ) );
        studentClass.setHostel( hostelDtoToHostel( dto.getHostel() ) );
        studentClass.setStudent( studentDtoToStudent( dto.getStudent() ) );
